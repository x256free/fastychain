...
// Service implements an FastyChain netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server       // Peer-to-peer server to retrieve networking infos
	eth    *eth.FastyChain      // Full FastyChain service if monitoring a full node
	les    *les.LightFastyChain // Light FastyChain service if monitoring a light node
...
func New(cfg Config, ethServ *eth.FastyChain, lesServ *les.LightFastyChain) *Service {
