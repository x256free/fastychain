...
type Database struct {
	diskdb common.Table // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb common.Table) *Database {
...
func NewDatabaseWithCache(diskdb common.Table, cache int) *Database {
...
func (db *Database) commit(hash common.Hash, batch common.Batch) error {
