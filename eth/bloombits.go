...
const (
	// bloomServiceThreads is the number of goroutines used globally by an FastyChain
...
func (gc *FastyChain) startBloomHandlers() {
...
// for the FastyChain header bloom filters, permitting blazing fast filtering.
