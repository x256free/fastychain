...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "fastychain.ipc", false, filepath.Join(os.TempDir(), "fastychain.ipc")},
		{"data", "fastychain.ipc", false, "data/fastychain.ipc"},
		{"data", "./fastychain.ipc", false, "./fastychain.ipc"},
		{"data", "/fastychain.ipc", false, "/fastychain.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "fastychain.ipc", true, `\\.\pipe\fastychain.ipc`},
		{"data", "fastychain.ipc", true, `\\.\pipe\fastychain.ipc`},
		{"data", `\\.\pipe\fastychain.ipc`, true, `\\.\pipe\fastychain.ipc`},
	}
