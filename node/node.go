...
import (
	...
	"github.com/x256free/fastychain/v4/ethdb/s3"
	"github.com/x256free/fastychain/v4/flock"
...
func (n *Node) startRPC(services map[reflect.Type]Service) error {
	...
	if err := n.startHTTP(n.httpEndpoint, apis, n.config.HTTPModules, n.config.HTTPCors, n.config.HTTPVirtualHosts, n.config.HTTPTimeouts, n.config.WSOrigins, n.config.HTTPTracing); err != nil {
		n.stopIPC()
		n.stopInProc()
		return err
	}
...
func (n *Node) startHTTP(endpoint string, apis []rpc.API, modules []string, cors []string, vhosts []string, timeouts rpc.HTTPTimeouts, wsOrigins []string, tracing bool) error {
	...
	handler := NewHTTPHandlerStack(srv, cors, vhosts, tracing)
