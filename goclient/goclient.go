...
func (ec *Client) getBlock(ctx context.Context, method string, args ...interface{}) (*types.Block, error) {
	...
	if err != nil {
		...
		return nil, fastychain.NotFound
	}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, fastychain.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*fastychain.SyncProgress, error) {
	var raw json.RawMessage
	...
	return &fastychain.SyncProgress{
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (fastychain.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q fastychain.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q fastychain.FilterQuery, ch chan<- types.Log) (fastychain.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q fastychain.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg fastychain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg fastychain.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg fastychain.CallMsg) (uint64, error) {
...
func toCallArg(msg fastychain.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
