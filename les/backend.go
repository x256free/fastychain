...
// Package les implements the Light FastyChain Subprotocol.
package les
...
func New(ctx context.Context, sctx *node.ServiceContext, config *eth.Config) (*LightFastyChain, error) {
...
func (s *LightFastyChain) APIs() []rpc.API {
...
func (s *LightFastyChain) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *LightFastyChain) BlockChain() *light.LightChain      { return s.blockchain }
func (s *LightFastyChain) TxPool() *light.TxPool              { return s.txPool }
func (s *LightFastyChain) Engine() consensus.Engine           { return s.engine }
func (s *LightFastyChain) LesVersion() int                    { return int(s.protocolManager.SubProtocols[0].Version) }
func (s *LightFastyChain) Downloader() *downloader.Downloader { return s.protocolManager.downloader }
func (s *LightFastyChain) EventMux() *core.InterfaceFeed      { return s.eventMux }

// Protocols implements node.Service, returning all the currently configured
// network protocols to start.
func (s *LightFastyChain) Protocols() []p2p.Protocol {
	return s.protocolManager.SubProtocols
}

// Start implements node.Service, starting all internal goroutines needed by the
// FastyChain protocol implementation.
func (s *LightFastyChain) Start(srvr *p2p.Server) error {
...
// FastyChain protocol.
func (s *LightFastyChain) Stop() error {
	s.odr.Stop()
