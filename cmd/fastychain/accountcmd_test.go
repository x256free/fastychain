...
func TestAccountListEmpty(t *testing.T) {
	geth := runFastyChain(t, "account", "list")
	geth.ExpectExit()
}

func TestAccountList(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	geth := runFastyChain(t, "account", "list", "--datadir", datadir)
...
func TestAccountNew(t *testing.T) {
	geth := runFastyChain(t, "account", "new", "--lightkdf")
	defer geth.ExpectExit()
	geth.Expect(`
...
func importAccountWithExpect(t *testing.T, key string, expected string) {
	...
	geth := runFastyChain(t, "account", "import", keyfile, "-password", passwordFile)
	defer geth.ExpectExit()
...
func TestAccountUpdate(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	geth := runFastyChain(t, "account", "update",
...
func TestWalletImport(t *testing.T) {
	geth := runFastyChain(t, "wallet", "import", "--lightkdf", "testdata/guswallet.json")
	defer geth.ExpectExit()
	geth.Expect(`
!! Unsupported terminal, password will be echoed.
