...
func loadConfig(file string, cfg *fastychainConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "fastychain.ipc"
	return cfg
}

func makeConfigNode(ctx *cli.Context) (*node.Node, fastychainConfig) {
	// Load defaults.
	cfg := fastychainConfig{
