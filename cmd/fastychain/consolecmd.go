...
var (
	...
	consoleCommand = cli.Command{
		...
		Description: `
Console is an interactive shell for the JavaScript runtime environment
...
func localConsole(ctx *cli.Context) error {
	...
	if err != nil {
		utils.Fatalf("Failed to attach to the inproc fastychain: %v", err)
	}
...
func remoteConsole(ctx *cli.Context) error {
	...
	if endpoint == "" {
		...
		endpoint = fmt.Sprintf("%s/fastychain.ipc", path)
	}
