...
type NodeConfig struct {
	...
	// EthereumEnabled specifies whether the node should run the FastyChain protocol.
	EthereumEnabled bool

	// EthereumNetworkID is the network identifier used by the FastyChain protocol to
...
// Node represents a FastyChain FastyChain node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new FastyChain node.
func NewNode(datadir string, config *NodeConfig) (stack *Node, _ error) {
	...
	// Register the FastyChain protocol if requested
...
// GetGoClient retrieves a client to access the FastyChain subsystem.
