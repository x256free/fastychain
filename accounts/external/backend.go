...
func (eb *ExternalBackend) Unsubscribe(ch chan<- accounts.WalletEvent) {
	// no op
}
...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain fastychain.ChainStateReader) {
