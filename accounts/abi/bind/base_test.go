...
func (mc *mockCaller) CallContract(ctx context.Context, call fastychain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call fastychain.CallMsg) ([]byte, error) {
